# -*- coding: utf-8 -*-
#
# lexrpc documentation Sphinx build configuration file.
#
...
# of the sidebar.
html_logo = '../static/atproto_logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
# html_favicon = '../static/atproto_logo.png'
...
latex_documents = [
  (master_doc, 'lexrpc.tex', 'lexrpc Documentation',
   'Ryan Barrett', 'manual'),
]
...
man_pages = [
    (master_doc, 'lexrpc', 'lexrpc documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'lexrpc', 'lexrpc Documentation',
   author, 'lexrpc', 'One line description of project.',
   'Miscellaneous'),
]
